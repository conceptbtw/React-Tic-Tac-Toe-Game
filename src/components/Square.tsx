...
const Square: React.FC<SquareProps> = ({ value, onSquareClick }) => {
  ...
  return (
    <button
      className="w-20 h-20 border border-text border-opacity-5 rounded-xl sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 hover:scale-105 active:scale-95 transition-all ease-in-out duration-250"
      aria-label="square"
